...
class QuotesSpider(scrapy.Spider):
    ...
    def spider_closed(self, spider):
        ...
        with open(f"output/ayp.json", "w", encoding="utf-8") as out:
            out.write(json_data)
    
    def start_requests(self):
        for i in range(1,55):     
            yield scrapy.Request(url=f'https://www.romaniayp.com/category/Architectural_services/{i}', callback=self.parse_two)
