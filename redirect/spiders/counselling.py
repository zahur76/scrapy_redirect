...
start_urls = [
                'https://www.counselling-directory.org.uk/search.php?search=England'
               ]
...
class QuotesSpider(scrapy.Spider):
    ...
    def spider_closed(self, spider):
        ...
        with open(f"output/counselling.json", "w", encoding="utf-8") as out:
            out.write(json_data)
    ...
    def parse_one(self, response):
        print(response.url)
        country_links = response.css('ul.c-search-suggestions__list li a::attr("href")').extract()
